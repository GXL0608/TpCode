export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version de TpCode",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} de TpCode a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.menu.help.documentation": "Documentation de TpCode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI TpCode est manquant. Essayez de réinstaller l'application de bureau.",
