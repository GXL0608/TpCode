export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av TpCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av TpCode er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.menu.help.documentation": "TpCode Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "TpCode CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
