export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de TpCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de TpCode. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentación de TpCode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de TpCode. Intenta reinstalar la aplicación de escritorio.",
