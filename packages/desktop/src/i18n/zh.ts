export const dict = {
  ...
  "desktop.updater.none.message": "你已经在使用最新版本的 TpCode",
  ...
  "desktop.updater.downloaded.prompt": "已下载 TpCode {{version}} 版本，是否安装并重启？",
  ...
  "desktop.menu.help.documentation": "TpCode 文档",
  ...
  "desktop.cli.error.sidecarMissing": "TpCode CLI 二进制文件缺失。请尝试重新安装桌面应用程序。",
