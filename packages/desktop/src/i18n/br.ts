export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do TpCode",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do TpCode foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentação do TpCode",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do TpCode está ausente. Tente reinstalar o aplicativo de desktop.",
