export const dict = {
  ...
  "desktop.menu.help.documentation": "TpCode Documentation",
  ...
  "desktop.updater.none.message": "You are already using the latest version of TpCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of TpCode has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.error.sidecarMissing": "TpCode CLI binary is missing. Try reinstalling the desktop app.",
