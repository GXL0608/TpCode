export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af TpCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af TpCode er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.menu.help.documentation": "TpCode Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing": "TpCode CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
