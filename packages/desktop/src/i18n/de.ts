export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von TpCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von TpCode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.error.sidecarMissing":
    "Das TpCode CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",
