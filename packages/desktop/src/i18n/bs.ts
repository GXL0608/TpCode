export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju TpCode-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} TpCode-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.menu.help.documentation": "TpCode Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka TpCode CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",
