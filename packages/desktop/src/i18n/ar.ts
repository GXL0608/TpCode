export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من TpCode",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من TpCode، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.menu.help.documentation": "وثائق TpCode",
  ...
  "desktop.cli.error.sidecarMissing": "ملف TpCode CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
