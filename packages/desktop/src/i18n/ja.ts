export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの TpCode を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "TpCode のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.menu.help.documentation": "TpCode ドキュメント",
  ...
  "desktop.cli.error.sidecarMissing":
    "TpCode CLI のバイナリが見つかりません。デスクトップアプリを再インストールしてみてください。",
