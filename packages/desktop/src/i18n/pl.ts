export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji TpCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} TpCode. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.menu.help.documentation": "Dokumentacja TpCode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego TpCode CLI. Spróbuj ponownie zainstalować aplikację na komputer.",
