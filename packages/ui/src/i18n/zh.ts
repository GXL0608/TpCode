...
export const dict = {
  ...
  "ui.sessionTurn.status.completedThinking": "已完成思考",
  "ui.sessionTurn.action.expand": "展开",
  "ui.sessionTurn.action.collapse": "折叠",
  ...
  "ui.messagePart.plan.save": "保存",
  "ui.messagePart.plan.saving": "保存中",
  "ui.messagePart.plan.saved": "已存",
  "ui.messagePart.plan.export": "导出计划",
  "ui.messagePart.plan.exported": "已导出",
  "ui.messagePart.plan.dialog.title": "保存计划",
  "ui.messagePart.plan.dialog.feedbackLabel": "VHO反馈号（选填）",
  "ui.messagePart.plan.dialog.feedbackPlaceholder": "请输入VHO反馈号",
  "ui.messagePart.plan.dialog.feedbackHint": "不填也可以直接保存。",
  "ui.messagePart.plan.dialog.cancel": "取消",
  "ui.messagePart.plan.dialog.confirm": "确认保存",
