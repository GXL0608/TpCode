...
const docs = `### Overview
Loads TpCode typography assets and mono nerd fonts.
...
export const Basic = {
  render: () => (
    <div style={{ display: "grid", gap: "8px" }}>
      <mod.Font />
      <div style={{ "font-family": "var(--font-family-sans)" }}>TpCode Sans Sample</div>
      <div style={{ "font-family": "var(--font-family-mono)" }}>TpCode Mono Sample</div>
    </div>
  ),
}
