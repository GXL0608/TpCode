...
export { TpProductSolutionTable } from "../user/product-solution.sql"
export { TpProductSolutionRootTable } from "../user/product-solution-root.sql"
export { TpProductSolutionBindingTable } from "../user/product-solution-binding.sql"
...
export { TpBuildJobTable } from "../build/job.sql"
export { TpBuildJobStageTable } from "../build/job-stage.sql"
export { TpBuildArtifactTable } from "../build/artifact.sql"
