...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "TpCode 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 TpCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 TpCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 TpCode 中使用 {{provider}} 模型。",
  ...
  "prompt.action.voiceStop": "停止录音",
  "prompt.action.selectFeedback": "选择反馈",
  "prompt.attachment.remove": "移除附件",
  "prompt.action.send": "发送",
  "prompt.action.stop": "停止",
  "prompt.voice.status.requesting": "请求麦克风权限中",
  "prompt.voice.status.recording": "录音中",
  "prompt.voice.status.transcribing": "转写中",
  "prompt.voice.status.failed": "语音输入失败",
  ...
  "prompt.toast.voiceUnsupported.title": "当前环境不支持语音输入",
  "prompt.toast.voiceUnsupported.description": "当前浏览器或 WebView 不支持麦克风录音。",
  "prompt.toast.voiceUnsupported.insecureContext": "当前页面不是 HTTPS 安全上下文，手机浏览器会禁用麦克风。请使用 HTTPS 域名访问。",
  "prompt.toast.voiceUnsupported.mediaDevices": "当前浏览器不支持麦克风采集接口。",
  "prompt.toast.voiceUnsupported.mediaRecorder": "当前浏览器不支持录音能力。建议使用最新版 Chrome 或 Safari。",
  "prompt.toast.voicePermissionDenied.title": "麦克风权限被拒绝",
  "prompt.toast.voicePermissionDenied.description": "请在浏览器或宿主应用中允许麦克风权限后重试。",
  "prompt.toast.voicePermissionTimeout.title": "等待麦克风权限超时",
  "prompt.toast.voicePermissionTimeout.description": "宿主应用未返回麦克风权限，请检查系统权限或改用 HTTPS 浏览器后重试。",
  "prompt.toast.voiceTooLong.title": "录音已在 60 秒自动停止",
  "prompt.toast.voiceTooLong.description": "单次录音最长 60 秒。",
  "prompt.toast.voiceTooLarge.title": "音频文件过大",
  "prompt.toast.voiceTooLarge.description": "单个音频文件最大 3 MB。",
  "prompt.toast.voiceRecordFailed.title": "录音失败",
  "prompt.toast.voiceRecordFailed.description": "请检查麦克风可用性后重试。",
  "prompt.toast.voiceTranscribeFailed.title": "语音转写请求失败",
  "prompt.toast.voiceTranscribeFailed.description": "请检查登录状态、转写模型配置或网络连接后重试。",
  "prompt.toast.voiceRecognitionUnsupported.title": "当前环境不支持语音转文字",
  "prompt.toast.voiceRecognitionUnsupported.description":
    "录音已附加到当前草稿。发送前请手动补充文字；发送后才会写入后台。",
  ...
  "dialog.server.description": "切换此应用连接的 TpCode 服务器。",
  ...
  "plan.feedback.dialog.title": "提交计划反馈",
  "plan.feedback.dialog.description":
    "计划已保存，你可以继续在下方第三方页面补充反馈内容。若当前环境不便内嵌展示，可直接在新窗口打开。",
  "plan.feedback.dialog.openExternal": "在新窗口打开",
  "plan.feedback.dialog.frameTitle": "计划反馈",
  "plan.feedback.toast.savedTitle": "计划已保存",
  "plan.feedback.toast.phoneRequiredToSave": "请先到设置-我的绑定手机号后再保存计划。",
  "plan.feedback.toast.phoneRequired": "请先绑定手机号后再提交反馈。",
  "plan.feedback.toast.phoneFetchFailed": "读取手机号失败，请稍后重试。",
  "dialog.vhoFeedback.title": "选择反馈",
  "dialog.vhoFeedback.description": "在 Build 模式下检索反馈任务，并将反馈问题和计划内容回填到当前输入框。",
  "dialog.vhoFeedback.userId": "反馈人手机号",
  "dialog.vhoFeedback.feedbackId": "反馈号",
  "dialog.vhoFeedback.planId": "计划 ID",
  "dialog.vhoFeedback.feedbackDes": "反馈描述",
  "dialog.vhoFeedback.resolutionStatus": "解决状态",
  "dialog.vhoFeedback.resolutionStatus.option.all": "全部",
  "dialog.vhoFeedback.resolutionStatus.option.0": "未解决",
  "dialog.vhoFeedback.resolutionStatus.option.1": "已解决",
  "dialog.vhoFeedback.resolutionStatus.option.9": "未标记",
  "dialog.vhoFeedback.planStartDate": "反馈开始日期",
  "dialog.vhoFeedback.planEndDate": "反馈结束日期",
  "dialog.vhoFeedback.pageSize": "每页条数",
  "dialog.vhoFeedback.pageSizeHint": "分页条数请在底部固定栏调整",
  "dialog.vhoFeedback.search": "查询",
  "dialog.vhoFeedback.searching": "查询中...",
  "dialog.vhoFeedback.reset": "重置",
  "dialog.vhoFeedback.empty": "暂无反馈数据，请先输入条件后查询。",
  "dialog.vhoFeedback.select": "选择并回填",
  "dialog.vhoFeedback.select.success": "反馈内容已回填到输入框",
  "dialog.vhoFeedback.select.successProject": "已切换到目标项目并回填反馈内容",
  "dialog.vhoFeedback.resolving": "回填中...",
  "dialog.vhoFeedback.prev": "上一页",
  "dialog.vhoFeedback.next": "下一页",
  "dialog.vhoFeedback.pagination": "第 {{page}} / {{total}} 页，共 {{count}} 条",
  "dialog.vhoFeedback.customer": "客户",
  "dialog.vhoFeedback.product": "产品",
  "dialog.vhoFeedback.module": "模块",
  "dialog.vhoFeedback.function": "功能",
  "dialog.vhoFeedback.feedbackUser": "反馈人",
  "dialog.vhoFeedback.feedbackTime": "反馈时间",
  "dialog.vhoFeedback.status": "状态",
  "dialog.vhoFeedback.rdTaskStatus": "研发状态",
  "dialog.vhoFeedback.demandType": "需求类型",
  "dialog.vhoFeedback.planIdLabel": "计划ID",
  "dialog.vhoFeedback.advanced.show": "高级筛选",
  "dialog.vhoFeedback.advanced.hide": "收起高级筛选",
  ...
  "session.header.workspace.error": "工作区异常",
  "session.header.workspace.currentDirectory": "当前目录",
  "session.header.workspace.projectRoot": "项目主目录",
  "session.header.workspace.branch": "分支",
  "session.header.workspace.status": "状态",
  ...
  "toast.update.description": "TpCode 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 TpCode 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: TpCode 暂不支持 MCP 认证。',
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 TpCode 服务器。",
  ...
  "settings.general.row.language.description": "更改 TpCode 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 TpCode 在你的设备上的外观",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 TpCode 的主题。",
  ...
  "settings.updates.row.startup.description": "在 TpCode 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 TpCode。",
  ...
  "workspace.reset.archive.failed.description":
    "工作区已重置，但有 {{count}} 个会话归档失败。请先处理这些会话后再继续。",
