export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by TpCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in TpCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in TpCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in TpCode.",
  ...
  "prompt.action.voiceStop": "Stop recording",
  "prompt.action.selectFeedback": "Select feedback",
  ...
  "dialog.server.description": "Switch which TpCode server this app connects to.",
  ...
  "dialog.vhoFeedback.title": "Select feedback",
  "dialog.vhoFeedback.description":
    "Search feedback tasks in Build mode and write the feedback problem together with saved plan content into the current prompt.",
  "dialog.vhoFeedback.userId": "Reporter phone number",
  "dialog.vhoFeedback.feedbackId": "Feedback ID",
  "dialog.vhoFeedback.planId": "Plan ID",
  "dialog.vhoFeedback.feedbackDes": "Feedback description",
  "dialog.vhoFeedback.resolutionStatus": "Resolution status",
  "dialog.vhoFeedback.resolutionStatus.option.all": "All",
  "dialog.vhoFeedback.resolutionStatus.option.0": "Unresolved",
  "dialog.vhoFeedback.resolutionStatus.option.1": "Resolved",
  "dialog.vhoFeedback.resolutionStatus.option.9": "Unmarked",
  "dialog.vhoFeedback.planStartDate": "Feedback start date",
  "dialog.vhoFeedback.planEndDate": "Feedback end date",
  "dialog.vhoFeedback.pageSize": "Page size",
  "dialog.vhoFeedback.pageSizeHint": "Change page size from the fixed footer below",
  "dialog.vhoFeedback.search": "Search",
  "dialog.vhoFeedback.searching": "Searching...",
  "dialog.vhoFeedback.reset": "Reset",
  "dialog.vhoFeedback.empty": "No feedback data yet. Enter filters and search.",
  "dialog.vhoFeedback.select": "Select and fill",
  "dialog.vhoFeedback.select.success": "Feedback content filled into the prompt",
  "dialog.vhoFeedback.select.successProject": "Switched to the target project and filled the feedback",
  "dialog.vhoFeedback.resolving": "Resolving...",
  "dialog.vhoFeedback.prev": "Previous",
  "dialog.vhoFeedback.next": "Next",
  "dialog.vhoFeedback.pagination": "Page {{page}} / {{total}}, {{count}} items",
  "dialog.vhoFeedback.customer": "Customer",
  "dialog.vhoFeedback.product": "Product",
  "dialog.vhoFeedback.module": "Module",
  "dialog.vhoFeedback.function": "Function",
  "dialog.vhoFeedback.feedbackUser": "Reporter",
  "dialog.vhoFeedback.feedbackTime": "Feedback time",
  "dialog.vhoFeedback.status": "Status",
  "dialog.vhoFeedback.rdTaskStatus": "R&D status",
  "dialog.vhoFeedback.demandType": "Demand type",
  "dialog.vhoFeedback.planIdLabel": "Plan ID",
  "dialog.vhoFeedback.advanced.show": "Advanced filters",
  "dialog.vhoFeedback.advanced.hide": "Hide advanced filters",
  ...
  "toast.update.description": "A new version of TpCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the TpCode team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, TpCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "TpCode includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the TpCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for TpCode",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how TpCode looks on your device",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how TpCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when TpCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of TpCode.",
